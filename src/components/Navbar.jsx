...
function Navbar() {
   ...
   return (
      <nav className='bg-sky-600 text-sky-100 font-bold text-base md:text-xl h-auto sm:h-20 w-full flex flex-col sm:flex-row justify-between items-center px-5 py-5 sm:py-0 gap-5'>
         <section>
            <NavLink to={'/'}>
               <h1 className='hover:scale-105'>Angel <br />SPA</h1>
            </NavLink>
         </section>
