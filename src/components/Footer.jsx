...
function Footer() {
   ...
   return (
      <footer
         className={`${isPathAuth && 'hidden'} ${isPathFavorite && 'fixed bottom-0'} bg-sky-600 w-full h-20 flex flex-col sm:flex-row justify-around items-center text-sky-100 md:text-xl font-medium`}
      >
