...
function Register() {
   ...
   return (
      <main className='flex justify-center items-center my-10'>
         <form
            className='flex flex-col justify-around font-semibold w-[23rem] bg-sky-300 ring-2 ring-sky-600 p-5 text-xl rounded-xl'
         ...
         >
            ...
            <button className='bg-sky-600 text-sky-100 m-auto px-9 rounded-md'>
               Register
            </button>
         </form>
         {!!error && 
